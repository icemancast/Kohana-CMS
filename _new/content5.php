...
<head>
	...
	<!-- For communitybible.com domain -->
	<!-- <script type="text/javascript" src="http://use.typekit.com/fyc2auk.js"></script>
	<script type="text/javascript">try{Typekit.load();}catch(e){}</script> -->
		...
		<div id="navbar">
			<nav>
				<ul>
					...
					<li> <div class="left-border"></div><!--nav divider--><img src="images/play.png"> Messages
					...
					<li><div class="left-border"></div><!--nav divider--><img src="images/help.png"> Need Help
						<ul>
							<li>Need Help</li>
					...
					<li><div class="left-border"></div><!--nav divider--><img src="images/connected.png"> Get Connected
						<ul>
							<li>Get Connected</li>
					...
					<li><div class="left-border"></div><!--nav divider--><img src="images/give.png">  Give
						<ul>
							<li>Giving</li>
							<li>Something Something</li>
							</ul>
