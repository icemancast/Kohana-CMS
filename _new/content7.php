...
<head>
	...
	<link rel="stylesheet"  media="screen" href="css/style7.css" />
...
<body>
		...
		<div id="navbar">
			<nav>
				<ul>
					...
					<li><div class="left-border"></div><!--nav divider--><p>Need Help</p>
						<ul>
							<li>Need Help</li>
					...
					<li><div class="left-border"></div><!--nav divider--> <p> Get Connected </p>
						<ul>
							<li>Get Connected</li>
					...
					<li><div class="left-border"></div><!--nav divider--> <p> Give </p>
						<ul>
							<li>Giving</li>
							<li>Something Something</li>
							</ul>
	...
	<section class="subcontent">
			<div id="header-pics">
				<div class="slideshow content-slideshow container_16">
