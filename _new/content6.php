...
<head>
	...
	<link rel="stylesheet"  media="screen" href="css/style6.css" />
		...
		<div id="navbar">
			<nav>
				<ul>
					...
					<li> <div class="left-border"></div><!--nav divider-->&nbsp;&nbsp;&nbsp;&nbsp; Messages&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<li><div class="left-border"></div><!--nav divider-->&nbsp;&nbsp;&nbsp;&nbsp;Need Help&nbsp;&nbsp;&nbsp;&nbsp;
						<ul>
							<li>Need Help</li>
					...
					<li><div class="left-border"></div><!--nav divider-->&nbsp;&nbsp;&nbsp;&nbsp; Get Connected&nbsp;&nbsp;&nbsp;&nbsp;
						<ul>
							<li>Get Connected</li>
					...
					<li><div class="left-border"></div><!--nav divider--> &nbsp;&nbsp;&nbsp;&nbsp; Give&nbsp;&nbsp;&nbsp;&nbsp;
						<ul>
							<li>Giving</li>
							<li>Something Something</li>
							</ul>
